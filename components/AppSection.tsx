        ...
        <div className="grid grid-cols-1 md:grid-cols-[0.8fr_1.2fr] gap-12 items-center">
          <div className="app__phone">
            <Image 
              ...
              width={1200}
              height={1600}
              className="w-full max-w-[400px] mx-auto rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,.25)]"
            />
          </div>
          
          <div className="app__content">
            <h2 className="text-[clamp(28px,4vw,56px)] leading-[1.1] m-0 mb-6 uppercase font-black">
              <span className="block text-[#2b3436]">WORKOUTS +</span>
              <span className="block text-[#2b3436]">NUTRITION</span>
              <span className="block highlight">ON THE GO</span>
            </h2>
            <p className="mb-8 text-[#243033] text-lg leading-relaxed">
